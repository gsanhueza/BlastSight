...
# Taken and adapted from https://github.com/bjorkegeek/polytri/blob/master/polytri.py
# Unavailable in PyPI, and the programmer left the original code in the Public Domain.
# Credits to https://github.com/bjorkegeek
