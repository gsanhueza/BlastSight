...
Dynamically loads an UI file using either PyQt{5/6} or PySide{2,6}.
At least works better than qtpy for the PySide{2,6} binding.
"""
...
def loadUi(uifile, baseinstance=None):
    if is_installed('PyQt5'):
        ...
        # Return PyQt6.ui.loadUi directly
        from PyQt6 import uic

        return uic.loadUi(uifile, baseinstance)

    elif is_installed('PySide2'):
        # Implement `PyQt5.uic.loadUi` for PySide2
        from PySide2.QtUiTools import QUiLoader
        from PySide2 import QtCore
        from PySide2 import QtWidgets

    elif is_installed('PySide6'):
        # Implement `PyQt6.uic.loadUi` for PySide6
