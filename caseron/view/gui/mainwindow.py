...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        # Extra actions
        self.toolbar.insertAction(self.toolbar.actions.action_plan_view, self.toolbar.actions.action_camera_properties)
        self.toolbar.addAction(self.toolbar.actions.action_quit)
    ...
    def generate_menubar(self):
        ...
        self.menu_File.addAction(self.toolbar.actions.action_load_blocks)
        self.menu_File.addAction(self.toolbar.actions.action_load_points)
        self.menu_File.addSeparator()
        self.menu_File.addAction(self.toolbar.actions.action_load_mesh_folder)
        self.menu_File.addAction(self.toolbar.actions.action_load_blocks_folder)
        self.menu_File.addAction(self.toolbar.actions.action_load_points_folder)
        self.menu_File.addSeparator()
        self.menu_File.addAction(self.toolbar.actions.action_quit)

        self.menu_View.addAction(self.toolbar.actions.action_camera_properties)
        self.menu_View.addAction(self.toolbar.actions.action_plan_view)
        self.menu_View.addAction(self.toolbar.actions.action_north_view)
        self.menu_View.addAction(self.toolbar.actions.action_east_view)
        self.menu_View.addAction(self.toolbar.actions.action_fit_to_screen)
        self.menu_View.addSeparator()
        self.menu_View.addAction(self.toolbar.actions.action_perspective_projection)
        self.menu_View.addAction(self.toolbar.actions.action_orthographic_projection)
        self.menu_View.addSeparator()
        self.menu_View.addAction(self.toolbar.actions.action_take_screenshot)

        self.menu_Tools.addAction(self.toolbar.actions.action_slice_mode)
        self.menu_Tools.addAction(self.toolbar.actions.action_detection_mode)
        self.menu_Tools.addAction(self.toolbar.actions.action_measurement_mode)
        self.menu_Tools.addSeparator()
        self.menu_Tools.addAction(self.toolbar.actions.action_normal_mode)

        self.menu_Help.addAction(self.toolbar.actions.action_help)
        self.menu_Help.addAction(self.toolbar.actions.action_about)

    def connect_actions(self):
        # File
        self.toolbar.actions.action_load_mesh.triggered.connect(self.dialog_load_mesh)
        self.toolbar.actions.action_load_blocks.triggered.connect(self.dialog_load_blocks)
        self.toolbar.actions.action_load_points.triggered.connect(self.dialog_load_points)

        self.toolbar.actions.action_load_mesh_folder.triggered.connect(self.dialog_load_mesh_folder)
        self.toolbar.actions.action_load_blocks_folder.triggered.connect(self.dialog_load_blocks_folder)
        self.toolbar.actions.action_load_points_folder.triggered.connect(self.dialog_load_points_folder)
        self.toolbar.actions.action_quit.triggered.connect(self.close)

        # View
        self.toolbar.actions.action_camera_properties.triggered.connect(self.dialog_camera)
        self.toolbar.actions.action_plan_view.triggered.connect(self.viewer.plan_view)
        self.toolbar.actions.action_north_view.triggered.connect(self.viewer.north_view)
        self.toolbar.actions.action_east_view.triggered.connect(self.viewer.east_view)
        self.toolbar.actions.action_fit_to_screen.triggered.connect(self.viewer.fit_to_screen)
        self.toolbar.actions.action_perspective_projection.triggered.connect(self.viewer.perspective_projection)
        self.toolbar.actions.action_orthographic_projection.triggered.connect(self.viewer.orthographic_projection)
        self.toolbar.actions.action_take_screenshot.triggered.connect(self.dialog_screenshot)

        # Tools
        self.toolbar.actions.action_detection_mode.triggered.connect(self.slot_detection_mode)
        self.toolbar.actions.action_slice_mode.triggered.connect(self.slot_slice_mode)
        self.toolbar.actions.action_measurement_mode.triggered.connect(self.slot_measurement_mode)
        self.toolbar.actions.action_normal_mode.triggered.connect(self.slot_normal_mode)

        # Help
        self.toolbar.actions.action_help.triggered.connect(self.slot_help)
        self.toolbar.actions.action_about.triggered.connect(self.slot_about)

        # Extra actions
        self.toolbar.actions.action_show_tree.triggered.connect(self.dockWidget.show)
